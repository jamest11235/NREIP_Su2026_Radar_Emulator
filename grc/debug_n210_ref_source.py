...
class debug_n210_ref_source(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "debug_n210_ref_source")
        ...
        self.uhd_usrp_source_0.set_samp_rate(500e3)
...
def main(top_block_cls=debug_n210_ref_source, options=None):
